...
const {isValidObjectId,isValidInputBody,isValidInputValue,isValidEmail,isValidPhone,isValidPincode,isValidProfile,isValidPassword}= require("../utilities/validator");
